module gospring-demo

go 1.20

require (
	github.com/go-spring/go-spring v1.0.2
	github.com/go-spring/go-spring-parent v1.0.4
	github.com/go-spring/go-spring-web v1.0.4
	github.com/go-sql-driver/mysql v1.7.1
	github.com/jmoiron/sqlx v1.3.5
	github.com/xcrossed/gospring-demo v0.0.0-20200501181339-b8303d1884a7
